            ...
            <div className=" mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-center  z-10">
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex flex-wrap gap-4 pt-4">
                        <button className=" btn bg-linear-to-r from-[#4F39F6] to-[#9514FA] transition-all px-3 py-6 rounded-full font-semibold text-lg text-white">
                            Explore Products
                        </button>
                        <button className=" bg-linear-to-r from-[#2e13f6] to-[#8c03f5] bg-clip-text text-transparent flex gap-3 justify-center items-center btn btn-outline btn-primary px-3 py-6 rounded-full">
