...
const Footer = () => {
    return (
        <div>
            <div className=' mb-20 mt-20 h-100 flex items-center justify-center w-full bg-linear-to-r from-[#4F39F6] to-[#9514FA]'>
                <div className=' flex flex-col items-center justify-center space-y-5'>
                    ...
                    <div className="flex flex-wrap gap-4 pt-4">
                        {/* Explore Products — white background, purple text */}
                        <button className="px-8 py-3 rounded-full bg-white text-purple-700 font-semibold hover:bg-gray-100">
                            Explore Products
                        </button>

                        {/* View Pricing — transparent background, white border, white text */}
